"""
Genera data.js a partir de StudentsPerformance.csv (mismo dataset usado en el
notebook docente de Semana 6, EIARV011_A6_Notebook.ipynb) para los cuatro
...
CSV_PATH = REPO_ROOT / "Semana_6" / "Semana_6_Actividad_solucion_profesor" / "StudentsPerformance.csv"
