"""
Genera data.js a partir de StudentsPerformance.csv (dataset usado en la guía de
estadística básica y en el taller de visualización de Semana 5) para los cuatro
...
CSV_PATH = REPO_ROOT / "Semana_5" / "01_ Estadistica_basica" / "StudentsPerformance.csv"
