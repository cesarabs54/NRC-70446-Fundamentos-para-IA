...
**Recurso interactivo de apoyo (opcional):** antes de empezar, explora el [**recurso interactivo de la Semana 5**](../../Aplicacion_interactiva_profesor/Semana_5/index.html) — en particular el módulo "Qué gráfico usar" y el módulo "Mismos datos, impresiones distintas" (bins y escala del eje), que reproducen en el navegador las mismas preguntas de los Ejercicios 1 a 6. No reemplaza el desarrollo del taller, pero ayuda a entender los conceptos antes de aplicarlos en el *Notebook*.
